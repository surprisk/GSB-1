...
('KM4D', 'Nombre Kilomètres Véhicule 4CV Diesel', 0.52),
('KM56D', 'Nombre Kilomètres Véhicule 5/6CV Diesel', 0.58),
('KM4E', 'Nombre Kilomètres Véhicule 4CV Essence', 0.62),
('KMV56E', 'Nombre Kilomètres Véhicule 5/6CV Essence', 0.67),
...
INSERT INTO `Utilisateur` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`, idTypeUser) VALUES
